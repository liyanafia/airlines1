<html>
	...
	<body>
		...
		<form class="center_form" action="new_user_form_handler.php" method="POST" id="new_user_from" style=" display:inline-block;">
			<h2><i class="fa fa-user-plus" aria-hidden="true"></i> CREATE NEW USER ACCOUNT</h2>
			<br>
			<table cellpadding='10'>
				<u><strong>LOGIN DETAILS</strong><u/> 
			...
			<br>
			<table cellpadding='10'>
				<u><strong>CUSTOMER'S PERSONAL DETAILS</strong><u/>
