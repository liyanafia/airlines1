...
<html>
	...
	<body>
		...
		<h1 id="title" style="color:#030337;">
			UNITY AIRLINES
		</h1>
		<div>
			<ul>
		...
		<br>
		<br>
		<div class="movetocenter" style="display:block; text-align: center;">
		<form class="center_form" style="padding-left: 40px" action="login_handler.php" method="POST" style=" display:inline-block;">
			<fieldset>
